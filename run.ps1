...
Write-Host "║                                                           ║"
Write-Host "║   ⚡ SoFi-QA - Synthetic Q&A Generator                    ║"
Write-Host "║                                                           ║"
Write-Host "╚═══════════════════════════════════════════════════════════╝" -ForegroundColor Magenta
Write-Host ""
...
if (Test-Path $VenvActivate) {
    ...
    Write-Host "⚠️  Could not find Activate.ps1, assuming python is in path or using global." -ForegroundColor Yellow
}
...
Write-Host ""
Write-Host "Press Ctrl+C to stop all servers (this usually kills the child processes too)" -ForegroundColor Yellow
...
try {
    ...
    Write-Host "🛑 Stopped servers." -ForegroundColor Red
}
